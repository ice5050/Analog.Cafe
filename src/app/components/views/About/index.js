...
export default props => {
	return(
		<Article>
			...
			/>
			<Section endsign>
				<Figure src="/images/figures/banner.jpg" feature>A lamp that lit the work table with the laptop, notebook and camera used to build this website. Shot on Ilfort Pan 400, pushed to 1600.</Figure>
				...
				<Figure src="/images/figures/about-chiangmai.jpg" feature>An overcast view of Doi Suthep mountain and Chiang Mai city at the foot of it. Shot on expired Macro Eagle TCS color surveilance film.</Figure>
				...
				<p>The individuals in this list are the first to offer their support and belief in this project. A huge round of applause and a low bow goes to this noble group! <span role="img" aria-label="Clapping hands and a bowing person">👏🙇</span></p>
				...
				<p>If you have a question, suggestion or just want to chat, feel free to follow and message on <Link to="https://twitter.com/analog_cafe">Twitter</Link>, <Link to="https://facebook.com/analog8cafe">Facebook</Link> or <Link to="https://instagram.com/analog_cafe">Instagram</Link>. Otherwise you can email <strong>d@analog.cafe</strong> <span role="img" aria-label="Envelope with a heart">💌</span></p>
