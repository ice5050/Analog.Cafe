...
export const ROUTE_APP_PRODUCTION_DOMAIN_NAME = "analog.cafe"
export const ROUTE_APP_PRODUCTION_DOMAIN_PROTOCOL = "https://www."
...
export const ROUTE_APP_CURRENT_DOMAIN = process.env.ANALOG_FRONTEND_URL
